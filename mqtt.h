...
#define HOTSPOT_WIFI  "pito"            /* Nombre del punto de acceso a conectarse */
...
#define TXTOPIC       "eslitop"         /* Nombre del topic de publicación */
#define RXTOPIC       "/topesli"         /* Nombre del topic de suscripción */
#define RXTOPIC1      "/esli2"        /* Nombre del topic de suscripción */
...
void MQTT :: publish_MQTT ( String msgs ) {
  ...
  client.publish(TXTOPIC, msgs.c_str());
  Serial.println(msgs);
